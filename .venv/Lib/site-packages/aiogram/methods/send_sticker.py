...
class SendSticker(TelegramMethod[Message]):
    ...
    """Sticker to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a .WEBP sticker from the Internet, or upload a new .WEBP, .TGS, or .WEBM sticker using multipart/form-data. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`. Video and animated stickers can't be sent via an HTTP URL."""
