...
class SendVoice(TelegramMethod[Message]):
    ...
    """Audio file to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`"""
