...
class ChatInviteLink(TelegramObject):
    ...
    invite_link: str
    """The invite link. If the link was created by another chat administrator, then the second part of the link will be replaced with 'Р В Р вЂ Р В РІР‚С™Р вЂ™Р’В¦'."""
    creator: User
    """Creator of the link"""
