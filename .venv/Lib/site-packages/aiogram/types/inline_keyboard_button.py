...
class InlineKeyboardButton(MutableTelegramObject):
    ...
    """*Optional*. Specify :code:`True`, to send a `Pay button <https://core.telegram.org/bots/api#payments>`_. Substrings 'Р В Р вЂ Р вЂ™Р’В­Р РЋРІР‚в„ў' and 'XTR' in the buttons's text will be replaced with a Telegram Star icon."""
