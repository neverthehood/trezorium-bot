...
class KeyboardButtonRequestUsers(TelegramObject):
    """
    This object defines the criteria used to request suitable users. Information about the selected users will be shared with the bot when the corresponding button is pressed. `More about requesting users Р В РІР‚в„ўР вЂ™Р’В» <https://core.telegram.org/bots/features#chat-and-user-selection>`_
