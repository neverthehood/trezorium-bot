...
class Message(MaybeInaccessibleMessage):
    ...
    """*Optional*. Message is a game, information about the game. `More about games Р В РІР‚в„ўР вЂ™Р’В» <https://core.telegram.org/bots/api#games>`_"""
    ...
    """*Optional*. Message is an invoice for a `payment <https://core.telegram.org/bots/api#payments>`_, information about the invoice. `More about payments Р В РІР‚в„ўР вЂ™Р’В» <https://core.telegram.org/bots/api#payments>`_"""
    successful_payment: Optional[SuccessfulPayment] = None
    """*Optional*. Message is a service message about a successful payment, information about the payment. `More about payments Р В РІР‚в„ўР вЂ™Р’В» <https://core.telegram.org/bots/api#payments>`_"""
    refunded_payment: Optional[RefundedPayment] = None
    """*Optional*. Message is a service message about a refunded payment, information about the payment. `More about payments Р В РІР‚в„ўР вЂ™Р’В» <https://core.telegram.org/bots/api#payments>`_"""
    ...
    """*Optional*. The domain name of the website on which the user has logged in. `More about Telegram Login Р В РІР‚в„ўР вЂ™Р’В» <https://core.telegram.org/widgets/login>`_"""
   ...
   https://core.telegram.org/bots/api-changelog#december-29-2023"""
    ...
    def reply_animation(
        ...
        **kwargs: Any,
        ...
        :param animation: Animation to send. Pass a file_id as String to send an animation that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get an animation from the Internet, or upload a new animation using multipart/form-data. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
        :param direct_messages_topic_id: Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
        :param duration: Duration of sent animation in seconds
        :param width: Animation width
        :param height: Animation height
        :param thumbnail: Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass 'attach://<file_attach_name>' if the thumbnail was uploaded using multipart/form-data under <file_attach_name>. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
    ...
    def reply_audio(
        ...
        **kwargs: Any,
        ...
        :param audio: Audio file to send. Pass a file_id as String to send an audio file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get an audio file from the Internet, or upload a new one using multipart/form-data. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
        :param direct_messages_topic_id: Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
    ...
    def reply_document(
        ...
        **kwargs: Any,
        ...
        :param document: File to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
        :param direct_messages_topic_id: Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
        :param thumbnail: Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass 'attach://<file_attach_name>' if the thumbnail was uploaded using multipart/form-data under <file_attach_name>. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
    ...
    def reply_photo(
        ...
        **kwargs: Any,
        ...
        :param photo: Photo to send. Pass a file_id as String to send a photo that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a photo from the Internet, or upload a new photo using multipart/form-data. The photo must be at most 10 MB in size. The photo's width and height must not exceed 10000 in total. Width and height ratio must be at most 20. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
        :param direct_messages_topic_id: Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
    ...
    def reply_dice(
        ...
        **kwargs: Any,
        ...
        :param direct_messages_topic_id: Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
        :param emoji: Emoji on which the dice throw animation is based. Currently, must be one of 'Р РЋР вЂљР РЋРЎСџР В РІР‚в„–Р В РІР‚В ', 'Р РЋР вЂљР РЋРЎСџР В РІР‚в„–Р В РІР‚РЋ', 'Р РЋР вЂљР РЋРЎСџР В Р РЏР В РІР‚С™', 'Р В Р вЂ Р РЋРІвЂћСћР В РІР‚В¦', 'Р РЋР вЂљР РЋРЎСџР В РІР‚в„–Р РЋРІР‚вЂњ', or 'Р РЋР вЂљР РЋРЎСџР В РІР‚в„–Р вЂ™Р’В°'. Dice can have values 1-6 for 'Р РЋР вЂљР РЋРЎСџР В РІР‚в„–Р В РІР‚В ', 'Р РЋР вЂљР РЋРЎСџР В РІР‚в„–Р В РІР‚РЋ' and 'Р РЋР вЂљР РЋРЎСџР В РІР‚в„–Р РЋРІР‚вЂњ', values 1-5 for 'Р РЋР вЂљР РЋРЎСџР В Р РЏР В РІР‚С™' and 'Р В Р вЂ Р РЋРІвЂћСћР В РІР‚В¦', and values 1-64 for 'Р РЋР вЂљР РЋРЎСџР В РІР‚в„–Р вЂ™Р’В°'. Defaults to 'Р РЋР вЂљР РЋРЎСџР В РІР‚в„–Р В РІР‚В '
        :param disable_notification: Sends the message `silently <https://telegram.org/blog/channels-2-0#silent-messages>`_. Users will receive a notification with no sound.
    ...
    def reply_sticker(
        ...
        **kwargs: Any,
        ...
        :param sticker: Sticker to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a .WEBP sticker from the Internet, or upload a new .WEBP, .TGS, or .WEBM sticker using multipart/form-data. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`. Video and animated stickers can't be sent via an HTTP URL.
        :param direct_messages_topic_id: Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
    ...
    def reply_video(
        ...
        **kwargs: Any,
        ...
        :param video: Video to send. Pass a file_id as String to send a video that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a video from the Internet, or upload a new video using multipart/form-data. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
        :param direct_messages_topic_id: Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
        :param duration: Duration of sent video in seconds
        :param width: Video width
        :param height: Video height
        :param thumbnail: Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass 'attach://<file_attach_name>' if the thumbnail was uploaded using multipart/form-data under <file_attach_name>. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
        :param cover: Cover for the video in the message. Pass a file_id to send a file that exists on the Telegram servers (recommended), pass an HTTP URL for Telegram to get a file from the Internet, or pass 'attach://<file_attach_name>' to upload a new one using multipart/form-data under <file_attach_name> name. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
    ...
    def reply_video_note(
        ...
        **kwargs: Any,
        ...
        :param video_note: Video note to send. Pass a file_id as String to send a video note that exists on the Telegram servers (recommended) or upload a new video using multipart/form-data. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`. Sending video notes by a URL is currently unsupported
        :param direct_messages_topic_id: Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
        :param duration: Duration of sent video in seconds
    ...
    def reply_voice(
        ...
        **kwargs: Any,
        ...
        :param voice: Audio file to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data. :ref:`More information on Sending Files Р В РІР‚в„ўР вЂ™Р’В» <sending-files>`
        :param direct_messages_topic_id: Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
