...
class WebAppChat(TelegramObject):
    ...
    type: str
    """Type of chat, can be either Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўgroupР В Р вЂ Р В РІР‚С™Р РЋРЎС™, Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўsupergroupР В Р вЂ Р В РІР‚С™Р РЋРЎС™ or Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўchannelР В Р вЂ Р В РІР‚С™Р РЋРЎС™"""
    title: str
    """Title of the chat"""
    username: Optional[str] = None
    """Username of the chat"""
    photo_url: Optional[str] = None
    """URL of the chatР В Р вЂ Р В РІР‚С™Р Р†РІР‚С›РЎС›s photo. The photo can be in .jpeg or .svg formats.
...
class WebAppUser(TelegramObject):
    ...
    photo_url: Optional[str] = None
    """URL of the userР В Р вЂ Р В РІР‚С™Р Р†РІР‚С›РЎС›s profile photo. The photo can be in .jpeg or .svg formats.
    Only returned for Web Apps launched from the attachment menu."""
...
class WebAppInitData(TelegramObject):
    ...
    Returned for supergroups, channels, and group chats Р В Р вЂ Р В РІР‚С™Р Р†Р вЂљРЎС™ only for Web Apps launched via the
    attachment menu."""
    chat_type: Optional[str] = None
    """Type of the chat from which the Web App was opened.
    Can be either Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўsenderР В Р вЂ Р В РІР‚С™Р РЋРЎС™ for a private chat with the user opening the link,
    Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўprivateР В Р вЂ Р В РІР‚С™Р РЋРЎС™, Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўgroupР В Р вЂ Р В РІР‚С™Р РЋРЎС™, Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўsupergroupР В Р вЂ Р В РІР‚С™Р РЋРЎС™, or Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўchannelР В Р вЂ Р В РІР‚С™Р РЋРЎС™.
