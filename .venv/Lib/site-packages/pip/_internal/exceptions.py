        ...
        if not options.ascii_only:
            ...
            if self.context is not None:
                yield _prefix_with_indent(
                    self.message,
                    console,
                    prefix=f"[{colour}]Р В РІР‚СљР Р†Р вЂљРІР‚Сњ[/] ",
                    indent=f"[{colour}]Р В Р вЂ Р Р†Р вЂљРЎСљР Р†Р вЂљРЎв„ў[/] ",
                )
                yield _prefix_with_indent(
                    self.context,
                    console,
                    prefix=f"[{colour}]Р В Р вЂ Р Р†Р вЂљРЎС›Р вЂ™Р’В°Р В Р вЂ Р Р†Р вЂљРЎСљР В РІР‚С™>[/] ",
                    indent=f"[{colour}]   [/] ",
                )
            else:
                yield _prefix_with_indent(
                    self.message,
                    console,
                    prefix="[red]Р В РІР‚СљР Р†Р вЂљРІР‚Сњ[/] ",
                    indent="  ",
                )
        else:
            yield self.message
