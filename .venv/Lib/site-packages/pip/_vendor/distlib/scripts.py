...
class ScriptMaker(object):
    ...
    def _get_shebang(self, encoding, post_interp=b'', options=None):
        ...
        # they aren't always. For example, a path containing a Р В Р’В±Р РЋРІР‚СњР РЋРІР‚С” (which is a
        # LATIN CAPITAL LETTER SHARP S - U+1E9E) is normcased to Р В РІР‚СљР РЋРЎСџ (which is a
