...
class Text(JupyterMixin):
        ...
        if _overflow != "ignore":
            ...
            if length > max_width:
                if _overflow == "ellipsis":
                    self.plain = set_cell_size(self.plain, max_width - 1) + "Р В Р вЂ Р В РІР‚С™Р вЂ™Р’В¦"
                else:
    ...
    def with_indent_guides(
        ...
        *,
        character: str = "Р В Р вЂ Р Р†Р вЂљРЎСљР Р†Р вЂљРЎв„ў",
        ...
        Args:
            ...
            character (str, optional): Character to use for indentation. Defaults to "Р В Р вЂ Р Р†Р вЂљРЎСљР Р†Р вЂљРЎв„ў".
