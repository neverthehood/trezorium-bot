...
class _BaseUrl:
    ...
    def host(self) -> str | None:
        ...
        If the URL must be punycode encoded, this is the encoded host, e.g if the input URL is `https://Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬.com`,
    ...
    def unicode_host(self) -> str | None:
        ...
        If the URL must be punycode encoded, this is the decoded host, e.g if the input URL is `https://Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬.com`,
        `unicode_host()` will be `Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬.com`
        """
    ...
    def unicode_string(self) -> str:
        ...
        If the URL must be punycode encoded, this is the decoded string, e.g if the input URL is `https://Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬.com`,
        `unicode_string()` will be `https://Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬Р В РІР‚в„ўР В РІвЂљВ¬.com`
        """
...
class HttpUrl(AnyUrl):
    ...
    * Max length 2083
    ...
    m1 = MyModel(url='http://punyР В РІР‚в„ўР В РІвЂљВ¬code.com')
    print(m1.url)
    #> http://xn--punycode-eja.com/
    m2 = MyModel(url='https://www.Р В Р’В Р вЂ™Р’В°Р В Р Р‹Р В РІР‚С™Р В Р Р‹Р В РІР‚С™Р В Р в‚¬Р В Р РЏР В Р’В Р вЂ™Р’Вµ.com/')
    print(m2.url)
    #> https://www.xn--80ak6aa92e.com/
    m3 = MyModel(url='https://www.example.Р В Р’В·Р В Р РЏР вЂ™Р’В Р В Р’ВµР вЂ™Р’В®Р РЋРЎС™/')
    print(m3.url)
