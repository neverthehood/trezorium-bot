...
class ArchiveUtilTestCase(support.TempdirManager):
    ...
    @pytest.mark.skipif("not can_fs_encode('Р В РІР‚СљР СћРЎвЂ™rchiv')")
    def test_make_tarball_latin1(self):
        """
        Mirror test_make_tarball, except filename contains latin characters.
        """
        self.test_make_tarball('Р В РІР‚СљР СћРЎвЂ™rchiv')  # note this isn't a real word

    @pytest.mark.skipif("not can_fs_encode('Р В РЎвЂ“Р В РЎвЂњР вЂ™Р’В®Р В РЎвЂ“Р Р†Р вЂљРЎв„ўР РЋРЎвЂєР В РЎвЂ“Р РЋРІР‚СљР РЋР’ВР В РЎвЂ“Р Р†Р вЂљРЎв„ўР вЂ™Р’В«Р В РЎвЂ“Р Р†Р вЂљРЎв„ўР вЂ™Р’В¤Р В РЎвЂ“Р РЋРІР‚СљР Р†Р вЂљРІР‚Сљ')")
    def test_make_tarball_extended(self):
        """
        Mirror test_make_tarball, except filename contains extended
        characters outside the latin charset.
        """
        self.test_make_tarball('Р В РЎвЂ“Р В РЎвЂњР вЂ™Р’В®Р В РЎвЂ“Р Р†Р вЂљРЎв„ўР РЋРЎвЂєР В РЎвЂ“Р РЋРІР‚СљР РЋР’ВР В РЎвЂ“Р Р†Р вЂљРЎв„ўР вЂ™Р’В«Р В РЎвЂ“Р Р†Р вЂљРЎв„ўР вЂ™Р’В¤Р В РЎвЂ“Р РЋРІР‚СљР Р†Р вЂљРІР‚Сљ')  # japanese for archive
