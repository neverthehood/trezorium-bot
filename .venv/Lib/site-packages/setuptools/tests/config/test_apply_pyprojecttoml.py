...
maintainers = [
  ...
  {name = "John X. Р В РІР‚СљР РЋРІР‚СљР В РІР‚СљР РЋРІР‚ВrР В РІР‚СљР вЂ™Р’В§eР В РІР‚СњР В Р Р‰", email = "john@utf8.org"},
  {name = "Р В РЎвЂєР Р†Р вЂљРЎС™Р В РЎвЂєР вЂ™Р’В±Р В РЎвЂєР РЋР’ВР В РЎвЂєР вЂ™Р’В± Р В РЎвЂ”Р вЂ™Р’В­Р Р†Р вЂљР Р‹ Р В Р’В¶Р РЋРЎС™Р вЂ™Р’В±", email = "gama@utf8.org"},
]
classifiers = [
...
maintainers = [
  {name = "Р В Р’В Р В Р вЂ№Р В Р Р‹Р Р†Р вЂљРЎв„ўР В Р’В Р вЂ™Р’ВµР В Р’В Р РЋРІР‚вЂќР В Р’В Р вЂ™Р’В°Р В Р’В Р В РІР‚В¦ Р В Р’В Р Р†Р вЂљР’ВР В Р’В Р вЂ™Р’В°Р В Р’В Р В РІР‚В¦Р В Р’В Р СћРІР‚ВР В Р’В Р вЂ™Р’ВµР В Р Р‹Р В РІР‚С™Р В Р’В Р вЂ™Р’В°", email = "Р В Р’В Р РЋРІР‚СњР В Р Р‹Р В РІР‚С™Р В Р’В Р РЋРІР‚ВР В Р Р‹Р Р†Р вЂљРІР‚СњР В Р’В Р В РІР‚В Р В Р’В Р РЋРІР‚СњР В Р’В Р вЂ™Р’В°@Р В Р’В Р РЋРІР‚СћР В Р Р‹Р РЋРІР‚СљР В Р’В Р В РІР‚В¦-Р В Р Р‹Р РЋРІР‚СљР В Р’В Р РЋРІР‚вЂќР В Р’В Р вЂ™Р’В°.Р В Р Р‹Р РЋРІР‚СљР В Р’В Р РЋРІР‚СњР В Р Р‹Р В РІР‚С™"},
]
"""
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            PEP621_EXAMPLE,
            (
                'Brett Cannon <brett@python.org>, "John X. Р В РІР‚СљР РЋРІР‚СљР В РІР‚СљР РЋРІР‚ВrР В РІР‚СљР вЂ™Р’В§eР В РІР‚СњР В Р Р‰" <john@utf8.org>, '
                'Р В РЎвЂєР Р†Р вЂљРЎС™Р В РЎвЂєР вЂ™Р’В±Р В РЎвЂєР РЋР’ВР В РЎвЂєР вЂ™Р’В± Р В РЎвЂ”Р вЂ™Р’В­Р Р†Р вЂљР Р‹ Р В Р’В¶Р РЋРЎС™Р вЂ™Р’В± <gama@utf8.org>'
            ),
            id='non-international-emails',
        ),
        pytest.param(
            PEP621_INTERNATIONAL_EMAIL_EXAMPLE,
            'Р В Р’В Р В Р вЂ№Р В Р Р‹Р Р†Р вЂљРЎв„ўР В Р’В Р вЂ™Р’ВµР В Р’В Р РЋРІР‚вЂќР В Р’В Р вЂ™Р’В°Р В Р’В Р В РІР‚В¦ Р В Р’В Р Р†Р вЂљР’ВР В Р’В Р вЂ™Р’В°Р В Р’В Р В РІР‚В¦Р В Р’В Р СћРІР‚ВР В Р’В Р вЂ™Р’ВµР В Р Р‹Р В РІР‚С™Р В Р’В Р вЂ™Р’В° <Р В Р’В Р РЋРІР‚СњР В Р Р‹Р В РІР‚С™Р В Р’В Р РЋРІР‚ВР В Р Р‹Р Р†Р вЂљРІР‚СњР В Р’В Р В РІР‚В Р В Р’В Р РЋРІР‚СњР В Р’В Р вЂ™Р’В°@Р В Р’В Р РЋРІР‚СћР В Р Р‹Р РЋРІР‚СљР В Р’В Р В РІР‚В¦-Р В Р Р‹Р РЋРІР‚СљР В Р’В Р РЋРІР‚вЂќР В Р’В Р вЂ™Р’В°.Р В Р Р‹Р РЋРІР‚СљР В Р’В Р РЋРІР‚СњР В Р Р‹Р В РІР‚С™>',
...
class TestPyModules:
    ...
    @pytest.mark.parametrize("module", ["pip-run", "abc-d.Р В РЎвЂєР вЂ™Р’В»-xyz-e"])
