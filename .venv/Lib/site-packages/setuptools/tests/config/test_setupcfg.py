...
class TestMetadata:
    ...
    def test_non_ascii_1(self, tmpdir):
        fake_env(tmpdir, '[metadata]\ndescription = Р В РІР‚СљР вЂ™Р’В©Р В РІР‚СљР вЂ™Р’В Р В РІР‚СљР В РІР‚РЋР В РІР‚СљР СћРІР‚ВР В РІР‚СљР вЂ™Р’В±\n', encoding='utf-8')
        with get_dist(tmpdir):
            pass
    ...
    def test_non_ascii_4(self, tmpdir):
        ...
        with get_dist(tmpdir) as dist:
            assert dist.metadata.description == 'Р В РІР‚СљР вЂ™Р’В©Р В РІР‚СљР вЂ™Р’В Р В РІР‚СљР В РІР‚РЋР В РІР‚СљР СћРІР‚ВР В РІР‚СљР вЂ™Р’В±'
