...
EXAMPLES = {
    ...
    "unicode-dist": {
        ...
        "unicodedist": {"__init__.py": "", "Р В РІР‚СљР СћРЎвЂ™Р В РІР‚СљР вЂ™Р’В¤Р В РІР‚СљР вЂ™Р’В¶_Р В Р’В¶Р Р†Р вЂљРІР‚СњР СћРЎвЂ™Р В Р’В¶Р РЋРЎв„ўР вЂ™Р’В¬Р В РЎвЂР В РІР‚С›Р РЋРІР‚С”.py": ""},
    },
    "utf8-metadata-dist": {
        "setup.cfg": cleandoc(
            """
            ...
            version = 42
            author_email = "John X. Р В РІР‚СљР РЋРІР‚СљР В РІР‚СљР РЋРІР‚ВrР В РІР‚СљР вЂ™Р’В§eР В РІР‚СњР В Р Р‰" <john@utf8.org>, Р В РЎвЂєР Р†Р вЂљРЎС™Р В РЎвЂєР вЂ™Р’В±Р В РЎвЂєР РЋР’ВР В РЎвЂєР вЂ™Р’В± Р В РЎвЂ”Р вЂ™Р’В­Р Р†Р вЂљР Р‹ Р В Р’В¶Р РЋРЎС™Р вЂ™Р’В± <gama@utf8.org>
            long_description = file: README.rst
            """
        ),
        "README.rst": "UTF-8 Р В Р’В¶Р В Р РЏР В Р РЏР В РЎвЂР РЋРІР‚вЂќР вЂ™Р’В° Р В РЎвЂР В РІР‚С›Р вЂ™Р’В¬Р В Р’В¶Р вЂ™Р’ВР В РІР‚в„–",
    },
    "licenses-dist": {
        "setup.cfg": cleandoc(
            """
...
def test_unicode_record(wheel_paths):
    ...
    assert "Р В РІР‚СљР СћРЎвЂ™Р В РІР‚СљР вЂ™Р’В¤Р В РІР‚СљР вЂ™Р’В¶_Р В Р’В¶Р Р†Р вЂљРІР‚СњР СћРЎвЂ™Р В Р’В¶Р РЋРЎв„ўР вЂ™Р’В¬Р В РЎвЂР В РІР‚С›Р РЋРІР‚С”.py".encode() in record
...
Name: helloworld
Version: 42
Author-email: "John X. Р В РІР‚СљР РЋРІР‚СљР В РІР‚СљР РЋРІР‚ВrР В РІР‚СљР вЂ™Р’В§eР В РІР‚СњР В Р Р‰" <john@utf8.org>, Р В РЎвЂєР Р†Р вЂљРЎС™Р В РЎвЂєР вЂ™Р’В±Р В РЎвЂєР РЋР’ВР В РЎвЂєР вЂ™Р’В± Р В РЎвЂ”Р вЂ™Р’В­Р Р†Р вЂљР Р‹ Р В Р’В¶Р РЋРЎС™Р вЂ™Р’В± <gama@utf8.org>


UTF-8 Р В Р’В¶Р В Р РЏР В Р РЏР В РЎвЂР РЋРІР‚вЂќР вЂ™Р’В° Р В РЎвЂР В РІР‚С›Р вЂ™Р’В¬Р В Р’В¶Р вЂ™Р’ВР В РІР‚в„–
"""
...
def test_preserve_unicode_metadata(monkeypatch, tmp_path):
    ...
    assert 'Author-email: "John X. Р В РІР‚СљР РЋРІР‚СљР В РІР‚СљР РЋРІР‚ВrР В РІР‚СљР вЂ™Р’В§eР В РІР‚СњР В Р Р‰"' in metadata
    assert "Р В РЎвЂєР Р†Р вЂљРЎС™Р В РЎвЂєР вЂ™Р’В±Р В РЎвЂєР РЋР’ВР В РЎвЂєР вЂ™Р’В± Р В РЎвЂ”Р вЂ™Р’В­Р Р†Р вЂљР Р‹ Р В Р’В¶Р РЋРЎС™Р вЂ™Р’В± " in metadata
    assert "UTF-8 Р В Р’В¶Р В Р РЏР В Р РЏР В РЎвЂР РЋРІР‚вЂќР вЂ™Р’В° Р В РЎвЂР В РІР‚С›Р вЂ™Р’В¬Р В Р’В¶Р вЂ™Р’ВР В РІР‚в„–" in metadata
