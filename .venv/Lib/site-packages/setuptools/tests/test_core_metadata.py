...
def __maintainer_test_cases():
    ...
    return [
        ...
        ('Author unicode', merge_dicts(attrs, {'author': 'Р В РІвЂћвЂ“Р Р†Р вЂљР’В°Р Р†Р вЂљРЎвЂєР В Р’В¶Р В РІР‚В Р РЋРЎвЂєР В Р’ВµР В РІР‚РЋР Р†Р вЂљРЎвЂќ'})),
        ('Maintainer unicode', merge_dicts(attrs, {'maintainer': 'Jan Р В РІР‚СћР В РЎвЂњukasiewicz'})),
    ]
