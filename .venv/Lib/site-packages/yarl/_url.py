...
class URL:
    ...
    def host(self) -> Optional[str]:
        ...
        if "%" in raw:
            ...
            # fe80::2%Р В Р’В Р РЋРЎСџР В Р’В Р вЂ™Р’ВµР В Р Р‹Р В РІР‚С™Р В Р’В Р вЂ™Р’ВµР В Р’В Р В РІР‚В Р В Р Р‹Р Р†Р вЂљРІР‚СљР В Р Р‹Р В РІР‚С™Р В Р’В Р РЋРІР‚СњР В Р’В Р вЂ™Р’В°
    ...
    def join(self, url: "URL") -> "URL":
        ...
        Construct a full (Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўabsoluteР В Р вЂ Р В РІР‚С™Р РЋРЎС™) URL by combining a Р В Р вЂ Р В РІР‚С™Р РЋРЎв„ўbase URLР В Р вЂ Р В РІР‚С™Р РЋРЎС™
